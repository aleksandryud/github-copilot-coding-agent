document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Handle difficulty filter - but NOT for "All Levels"
      // When "All Levels" is selected (empty string), we want activities WITHOUT difficulty field
      // This is handled client-side, so we don't send it to the API
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter for "All Levels" case
      // When "All Levels" is selected (empty string), only show activities WITHOUT difficulty field
